...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/19 16:00:08 by opacaud           #+#    #+#             */
/*   Updated: 2022/01/19 16:00:08 by opacaud          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap()
{
    ...
    m_energyPoints = 100;
    m_attackDamage = 30;
    m_frag_hitPoints = 100;
    m_frag_energyPoints = 100;
    m_frag_attackDamage = 30;
}
...
FragTrap & FragTrap::operator=(FragTrap const & FragTrapACopier)
{
    ...
    if (this != &FragTrapACopier)
    {
        ...
        m_frag_hitPoints = FragTrapACopier.m_frag_hitPoints;
        m_frag_energyPoints = FragTrapACopier.m_frag_energyPoints;
        m_frag_attackDamage = FragTrapACopier.m_frag_attackDamage;
    }
    return (*this);
}
