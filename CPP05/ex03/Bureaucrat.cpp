...
void    Bureaucrat::signForm(Form & form)
{
    ...
    {
        form.beSigned(*this);
        std::cout << BOLDGREEN  << m_name << " signs " << form.getName() << RESET << std::endl;
    }
    catch (std::exception & e)
    {
        std::cout << BOLDRED << m_name << " cannot sign because: " << e.what() << RESET << std::endl;
    }
}
...
void    Bureaucrat::executeForm(Form const & form)
{
    ...
    {
        form.execute(*this);
        std::cout << BOLDGREEN << m_name << " executes " << form.getName() << RESET << std::endl;
    }
    catch (std::exception & e)
    {
        std::cout << BOLDRED << m_name << " cannot execute because: " << e.what() << RESET << std::endl;
    }
}
