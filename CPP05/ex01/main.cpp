...
{  
	...
	std::cout << BOLDMAGENTA << std::endl << "------------------TESTS BESIGNED------------------" << RESET << std::endl << std::endl;
	...
	std::cout << BOLDMAGENTA << std::endl << "------------------TESTS SIGNFORM------------------" << RESET << std::endl << std::endl;
    ...
    std::cout << BOLDMAGENTA << "---------------------THE  END---------------------" << RESET << std::endl << std::endl;
